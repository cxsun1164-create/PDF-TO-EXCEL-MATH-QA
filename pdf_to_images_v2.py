...
# ---------------------------------------------------------------------------
PDF_MAPPING = {
    "01：有理数计算（500题）.pdf": {"q_range": (1, 52), "a_range": (53, 64)},
    "02：绝对值化简（110题）.pdf": {"q_range": (1, 11), "a_range": (12, 32)},
    "03：整式加减运算（200题）.pdf": {"q_range": (1, 30), "a_range": (31, 51)},
    "04：一元一次方程（50题）.pdf": {"q_range": (1, 5), "a_range": (6, 8)},   # 请按实际补全
    "05：整式乘法与因式分解（500题）.pdf": {"q_range": (1, 42), "a_range": (43, 103)},
    "06：不等式专项练习（200题）.pdf": {"q_range": (1, 39), "a_range": (40, 46)},
    "07：二元一次方程组（50题）.pdf": {"q_range": (1, 4), "a_range": (5, 19)},
}
